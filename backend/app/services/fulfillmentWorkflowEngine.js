...
const FULFILLMENT_TRANSITIONS = {
  [WORKFLOW_STATUS.CREATED]: new Set([WORKFLOW_STATUS.SELLER_PENDING, WORKFLOW_STATUS.ORDER_PLACED]),
  ...
  [WORKFLOW_STATUS.ORDER_PLACED]: new Set([WORKFLOW_STATUS.PAYMENT_CONFIRMED, WORKFLOW_STATUS.PAYMENT_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PAYMENT_CONFIRMED]: new Set([WORKFLOW_STATUS.INVENTORY_RESERVED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.INVENTORY_RESERVED]: new Set([WORKFLOW_STATUS.PROCUREMENT_REQUIRED, WORKFLOW_STATUS.PROCUREMENT_COMPLETED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PROCUREMENT_REQUIRED]: new Set([WORKFLOW_STATUS.PROCUREMENT_COMPLETED, WORKFLOW_STATUS.PROCUREMENT_FAILED, WORKFLOW_STATUS.SELLER_REJECTED, WORKFLOW_STATUS.SELLER_TIMEOUT, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PROCUREMENT_COMPLETED]: new Set([WORKFLOW_STATUS.READY_FOR_PICKUP, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.READY_FOR_PICKUP]: new Set([WORKFLOW_STATUS.PICKUP_ASSIGNED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PICKUP_ASSIGNED]: new Set([WORKFLOW_STATUS.SELLER_READY, WORKFLOW_STATUS.PICKUP_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.SELLER_READY]: new Set([WORKFLOW_STATUS.PICKED_UP, WORKFLOW_STATUS.PICKUP_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PICKED_UP]: new Set([WORKFLOW_STATUS.IN_TRANSIT_TO_HUB, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.IN_TRANSIT_TO_HUB]: new Set([WORKFLOW_STATUS.RECEIVED_AT_HUB, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.RECEIVED_AT_HUB]: new Set([WORKFLOW_STATUS.QA_PENDING, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.QA_PENDING]: new Set([WORKFLOW_STATUS.QA_PASSED, WORKFLOW_STATUS.QA_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.QA_PASSED]: new Set([WORKFLOW_STATUS.PACKING, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.PACKING]: new Set([WORKFLOW_STATUS.READY_FOR_DELIVERY, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.READY_FOR_DELIVERY]: new Set([WORKFLOW_STATUS.DELIVERY_ASSIGNED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.DELIVERY_ASSIGNED]: new Set([WORKFLOW_STATUS.OUT_FOR_DELIVERY, WORKFLOW_STATUS.DELIVERY_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
  [WORKFLOW_STATUS.OUT_FOR_DELIVERY]: new Set([WORKFLOW_STATUS.DELIVERY_OTP_VERIFIED, WORKFLOW_STATUS.DELIVERED, WORKFLOW_STATUS.DELIVERY_FAILED, WORKFLOW_STATUS.ORDER_CANCELLED]),
...
function assertRoleAllowed(toState, actor = {}, domain = "fulfillment") {
  ...
  if (domain === "fulfillment") {
    if ([WORKFLOW_STATUS.QA_PASSED, WORKFLOW_STATUS.DELIVERY_ASSIGNED, WORKFLOW_STATUS.ORDER_CANCELLED, WORKFLOW_STATUS.CANCELLED].includes(toState) && role !== "admin") {
