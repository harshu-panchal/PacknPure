    ...
    <div className={cn("space-y-1.5", className)}>
      ...
      <div className="relative group">
        {Icon && (
          <Icon
            size={16}
            className="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-300 transition-colors duration-200 group-focus-within:text-red-600"
            aria-hidden
          />
        )}
        <input
          ...
          className={cn(
            ...
            "focus:bg-white focus:ring-2 focus:ring-red-500/80 focus:shadow-[0_0_0_4px_rgba(226,55,68,0.12)]",
            "disabled:opacity-60",
